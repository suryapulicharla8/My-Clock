...
function settime(){
    ...
    if(i== hourr){
        ...
        document.getElementById("image-select").style.backgroundImage= "url(goodMorning-png-2.png)";
        document.getElementById("left-scr-msg").innerHTML="WakeUp and See The Sun-Shine";
    }
    else if(j==hourr){
        document.getElementById("image-select").style.backgroundImage= "url(gud-afternoon-img.jpg)";
        document.getElementById("left-scr-msg").innerHTML="Let's make a Party";
    }
    else if(k==hourr){
        document.getElementById("image-select").style.backgroundImage= "url(goodEvening-png-2.png)";
        document.getElementById("left-scr-msg").innerHTML="it's time to tea";
    }
    else if(l==hourr){
        document.getElementById("image-select").style.backgroundImage= "url(goodNight-png-2.png)";
